...
const archiveLink = (
  <a href="https://archive.dominicduan.com/" rel="noreferrer" target="_blank">
    Obfuscation Identity Archive
  </a>
);

const repositoryLink = (
  <a href="https://github.com/Linglingletsgo/obfuscation-identity-archive-survey" rel="noreferrer" target="_blank">
    repository
  </a>
);
...
> = {
  default: {
    ...
    intro: [
      ...
      "This archive entry process does not ask you to describe your true self. Instead, you are invited to assemble an obfuscation identity through selected tags and one carried fragment. This identity may be partial, fictional, misleading, poetic, contradictory, or unstable.",
      <>
        Your submitted archive entry will be stored in the {repositoryLink} and automatically archived into{" "}
        {archiveLink}, where it becomes part of the published archive system and its avatar-generation pipeline.
      </>
    ],
    protocolTitle: "Archive protocol",
    protocolItems: [
      "No directly identifying details",
      "Fictional, misleading, and contradictory fragments are valid",
      "Keep your submission ID after submitting"
    ],
    structureTitle: "Archive entry structure",
    structureItems: [
      "15 archive steps in total",
  ...
  "zh-cn": {
    ...
    intro: [
      ...
      "这个档案化过程并不是要求你描述真实的自己。相反，你将通过选择标签，并留下一段携带文字片段，组装一个“混淆身份”。这个身份可以是局部的、虚构的、误导性的、诗意的、矛盾的或不稳定的。",
      <>
        你提交的档案条目会被保存到 {repositoryLink}，并自动归档到 {archiveLink}
        ，成为公开档案系统及其 avatar 生成流程的一部分。
      </>
    ],
    protocolTitle: "档案协议",
    protocolItems: [
